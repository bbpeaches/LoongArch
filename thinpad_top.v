...
async_receiver #(.ClkFrequency(140000000), .Baud(115200)) ext_uart_r (
    .clk(clk_sram),
    .RxD(rxd),
...
async_transmitter #(.ClkFrequency(140000000), .Baud(115200)) ext_uart_t (
    .clk(clk_sram),
    .TxD(txd),
