module stage_id (
    ...
    assign id_rs1 = id_invalid ? 5'd0 : dec_rs1;
    assign id_rs2 = id_invalid ? 5'd0 : dec_rs2;
    ...
    assign id_is_branch = !id_invalid && (inst_b | is_bl | is_jirl | inst_cond_branch);

    wire actual_taken  = !id_invalid && (inst_b | is_bl | is_jirl |
